...
import { stopGame, startGame } from "../../../features/game/gameSlice"
...
const Layout = () => {
    ...
    return (
        <div className="action-buttons flex flex-wrap gap-2 items-center">
            <button style={buttonStyleByState} className={`text-white font-bold py-2 px-4 rounded-full`} onClick={handleStart}>Start</button>
